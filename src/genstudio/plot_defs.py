...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["areaX", values, {**options, **kwargs}]))
...
channel (possibly to null) is strongly recommended.
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["areaY", values, {**options, **kwargs}]))
...
```
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["arrow", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["autoSpec", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["axisFx", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["axisFy", values, {**options, **kwargs}]))
...
option to rotate.
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["axisX", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["axisY", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["bollinger", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["bollingerX", values, {**options, **kwargs}]))
...
not specified, it defaults to [0, 1, 2, …].
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["bollingerY", values, {**options, **kwargs}]))
...
```
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["cellX", values, {**options, **kwargs}]))
...
```
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["cellY", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["circle", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["cluster", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["contour", values, {**options, **kwargs}]))
...
one-dimensional.
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["crosshair", values, {**options, **kwargs}]))
...
binning.
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["crosshairX", values, {**options, **kwargs}]))
...
binning.
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["crosshairY", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["delaunayLink", values, {**options, **kwargs}]))
...
separate Delaunay triangulation for each group.
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["delaunayMesh", values, {**options, **kwargs}]))
...
contour.
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["density", values, {**options, **kwargs}]))
...
frame.
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["differenceY", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["graticule", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["hexagon", values, {**options, **kwargs}]))
...
[*y₀*, *y₁*, *y₂*, …].
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["image", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["interpolatorBarycentric", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["interpolatorRandomWalk", values, {**options, **kwargs}]))
...
```
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["lineX", values, {**options, **kwargs}]))
...
```
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["lineY", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["linearRegressionX", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["linearRegressionY", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["raster", values, {**options, **kwargs}]))
...
```
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["rectX", values, {**options, **kwargs}]))
...
```
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["rectY", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["ruleX", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["ruleY", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["sphere", values, {**options, **kwargs}]))
...
```
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["spike", values, {**options, **kwargs}]))
...
middle of the interval.
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["textX", values, {**options, **kwargs}]))
...
middle of the interval.
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["textY", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["tickX", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["tickY", values, {**options, **kwargs}]))
...
*y₀*], [*x₁*, *y₁*], [*x₂*, *y₂*], …]
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["vector", values, {**options, **kwargs}]))
...
*x₂*, …].
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["vectorX", values, {**options, **kwargs}]))
...
*y₂*, …].
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["vectorY", values, {**options, **kwargs}]))
...
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["voronoi", values, {**options, **kwargs}]))
...
separate Voronoi tesselation for each group.
"""
    return PlotSpec(JSCall("View", "MarkSpec", ["voronoiMesh", values, {**options, **kwargs}]))
